...
export const LANGUAGES = {
  ...
  german: {
    ...
    words: [
      ...
      { word: "WOLKE", translation: "cloud", hint: "Floats in the sky", example: "Die Wolke ist weiß.", exampleTranslation: "The cloud is white." },
  ...
  portuguese: {
    ...
    words: [
      ...
      { word: "PEIXE", translation: "fish", hint: "Lives in water", example: "O peixe nada rápido.", exampleTranslation: "The fish swims fast." },
